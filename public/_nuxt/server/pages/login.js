...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/login.vue?vue&type=template&id=61dfa638&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',{staticClass:"mx-auto pa-10",attrs:{"width":"500"}},[(_vm.isLoggedIn)?_c('div',[_vm._v("\n    Bienvenido "+_vm._s(_vm.authUser.email)+"\n  ")]):_c('div',[_c('h1',[_vm._v("Login")]),_vm._v(" "),(_vm.cargando)?_c('div',[_c('v-progress-circular',{attrs:{"indeterminate":"","color":"primary"}})],1):_c('div',[_c('v-form',{model:{value:(_vm.formValid),callback:function ($$v) {_vm.formValid=$$v},expression:"formValid"}},[_c('v-text-field',{attrs:{"label":"E-mail","prepend-icon":"mdi-email-outline"},model:{value:(_vm.formData.email),callback:function ($$v) {_vm.$set(_vm.formData, "email", $$v)},expression:"formData.email"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Password","type":"password","prepend-icon":"mdi-form-textbox-password "},model:{value:(_vm.formData.password),callback:function ($$v) {_vm.$set(_vm.formData, "password", $$v)},expression:"formData.password"}})],1),_vm._v(" "),_c('v-row',[_c('v-spacer'),_vm._v(" "),_c('v-col',{staticClass:"mr-n16"},[_c('a',{attrs:{"href":"#"}},[_vm._v(" Olvidé mi contraseña")])])],1),_vm._v(" "),_c('center',[_c('div',[_c('v-btn',{attrs:{"disabled":!_vm.formValid,"color":"primary","dark":"","x-large":""},on:{"click":function($event){return _vm.signInUser()}}},[_vm._v("\n            Entrar\n          ")])],1)])],1)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/login.vue?vue&type=template&id=61dfa638&
...
/* harmony default export */ var loginvue_type_script_lang_js_ = ({
  ...
  methods: {
    async createUser() {
      try {
        this.cargando = true;
        await this.$fire.auth.createUserWithEmailAndPassword(this.formData.email, this.formData.password);
        this.$router.push('/');
        this.cargando = false;
      } catch (e) {
        alert(e);
    ...
    async signInUser() {
      try {
        this.cargando = true;
        await this.$fire.auth.signInWithEmailAndPassword(this.formData.email, this.formData.password);
        this.$router.push('/');
      } catch (e) {
        alert(e);
        this.cargando = false;
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCol: VCol["a" /* default */],VForm: VForm,VProgressCircular: VProgressCircular["a" /* default */],VRow: VRow["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})
